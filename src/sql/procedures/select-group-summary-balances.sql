...
begin
    select agr.account_group_id group_id, agr.account_id, 
    ...
    left join (select * from transactions where date_posted <= p_to_date) t on agr.account_id in (to_id, from_id) 
